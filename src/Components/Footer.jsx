...
export default function Footer() {
  return (
    <footer className="bg-orange-950 text-white font-bold  font-sans ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 ">BioAlpine</h3>
            <p className="text-gray-400">Redefining modern essentials for the conscious consumer.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 font-sans" >
          <p>&copy; {new Date().getFullYear()} BioAlpine. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
